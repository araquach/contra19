    ...
    <section id="bespoke" class="bespoke hero is-medium">
        <div class="hero-body show columns">
            ...
            <div class="section column is-7">
                <h1 class="title is-1 is-size-3-mobile has-text-centered">Bespoke Handcrafted Designs</h1>
                ...
                <p class="is-size-5 is-size-6-mobile"><strong>Don't make the mistake of getting stuck with a limiting template based website with no room for future development!</strong></p>
